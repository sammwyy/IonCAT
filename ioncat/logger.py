...
def err(message: str):
    ...
    print(f"{GLOBAL_PREFIX}{ERR_PREFIX}{format(message)}")
    
def warn(message: str):
    if HEADLESS and message == "": return
    print(f"{GLOBAL_PREFIX}{WARN_PREFIX}{format(message)}")
    
def info(message: str): 
    if HEADLESS and message == "": return
    print(f"{GLOBAL_PREFIX}{INFO_PREFIX}{format(message)}")